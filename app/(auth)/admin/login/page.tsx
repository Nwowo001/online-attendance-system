  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="card p-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        ...
        <Button type="submit" className="w-full" loading={isSubmitting}>Sign In as Admin</Button>
      </form>
      ...
      <div className="mt-6 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
        <p className="text-xs font-medium text-purple-700 dark:text-purple-400 mb-1">Demo Admin</p>
        <p className="text-xs text-purple-600 dark:text-purple-300">admin@demo.com / password123</p>
      </div>
    </motion.div>
  );
}
